...
#define D_MAX_DATA_UNITS_IN_MCU                  \
    10 /* decompressor's limit on data units/MCU \
        */
#endif
    ...
    struct jpeg_memory_mgr
    {
        ...
        JMETHOD(JBLOCKARRAY, alloc_barray,
                (j_common_ptr cinfo, int pool_id, JDIMENSION blocksperrow,
                 JDIMENSION numrows));
#ifdef NEED_DARRAY
        JMETHOD(JDIFFARRAY, alloc_darray,
                (j_common_ptr cinfo, int pool_id, JDIMENSION diffsperrow,
                 JDIMENSION numrows));
#endif
...
#define jpeg_create_decompress(cinfo)                \
    ...
    EXTERN(void)
    jpeg_simple_lossless JPP((j_compress_ptr cinfo, int predictor,
                              int point_transform));
    EXTERN(void)
    ...
    jpeg_write_m_header JPP((j_compress_ptr cinfo, int marker,
                             unsigned int datalen));
    EXTERN(void)
    jpeg_write_m_byte JPP((j_compress_ptr cinfo, int val));
