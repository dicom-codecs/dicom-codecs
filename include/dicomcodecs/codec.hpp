...
typedef void (*decoder_ptr)(const std::vector<uint8_t> & encodedBytes, dicomcodecs::image& targetImage);
typedef void (*encoder_ptr)(const dicomcodecs::image& sourcerImage, std::vector<uint8_t> & encodedBytes);
