...
void kakadu_decoder(const vector<uint8_t> &encodedBytes, image &targetImage);
...
#ifdef DICOM_CODECS_KAKADU
  registerDecoder("kakadu", kakadu_decoder);
  registerEncoder("kakadu", kakadu_encoder);
#endif
}
